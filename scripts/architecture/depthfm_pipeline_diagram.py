...
``depth_fm.data.adapter`` inline in the graph.
...
# ===========================================================================
# ADAPTER ALGORITHMS  (mirrored from depth_fm.data.adapter)
# ===========================================================================
...
def main(out_dir: str | Path = "outputs/figures") -> None:
    ...
    print(f"Adapter source: "
          f"{'REAL depth_fm.data.adapter' if _USING_REAL_ADAPTER else 'bundled fallback (bit-identical)'}")
