...
from depth_fm.objectives.losses import CombinedLoss, PhotoclinometricLoss
...
from depth_fm.objectives.metrics import compute_depth_metrics, compute_photo_consistency, MetricsAggregator
from depth_fm.models.mars_depthfm import build_model
...
def _vis_worker_main(task_queue: mp.SimpleQueue, staging_dir: str, rank: int):
    ...
    from depth_fm.objectives.metrics import affine_align as _align
